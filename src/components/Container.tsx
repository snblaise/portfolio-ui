...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Blaise S. N.",
    description: `Senior DevSecOps Engineer with 10+ years of cloud security expertise.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://www.blaisesn.codes${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://www.blaisesn.codes${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Blaise S. N." />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="Blaise S. N." />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">Blaise</span>
        </Link>
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <div className="flex min-h-fit w-full flex-col space-y-8 px-[22px] py-10">
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} Blaise. All rights reserved.
                  </span>
                </div>
              </div>
            </motion.div>
